    ...
    <div class="container-fluid mt--7">
        <div class="row">
            <div class="col-xl-8 mb-5 mb-xl-0">
                <h2 class="dashboard-tracks-title">Last Courses</h2>
                @if(count($courses))
                    <div class="table-responsive dashboard-courses">
                        <table class="table align-items-center table-flush">
                            ...
                            <tr>
                                ...
                                <th scope="col">{{ __('No. Students') }}</th>
                            ...
                            @foreach ($courses as $course)
                                <tr>
                                    ...
                                    <td>{{ count($course->users) }} students</td>
                                    <td>
            ...
            <div class="col-xl-4">
                <h2 class="dashboard-tracks-title">Last Tracks</h2>
                @if(count($tracks))
                    <div class="table-responsive dashboard-tracks">
                        <table class="table align-items-center table-flush">
                            <thead class="thead-light">
                            <tr>
        ...
        <div class="row mt-5">
            <div class="col-xl-8 mb-5 mb-xl-0">
                ...
                <h2 class="dashboard-users-title">Last Users</h2>
                    @if(count($users))
                    <div class="table-responsive dashboard-tracks">
                        <table class="table align-items-center table-flush">
                            <thead class="thead-light">
            ...
            <div class="col-xl-4">
                ...
                <h2 class="dashboard-quizzes-title">Last Quizzes</h2>
                @if(count($quizzes))
                    <div class="table-responsive dashboard-tracks">
                        <table class="table align-items-center table-flush">
                            <thead class="thead-light">
